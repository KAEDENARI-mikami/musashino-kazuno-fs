...
export default defineConfig(({ mode }) => {
  ...
  const githubPagesBase = process.env.GITHUB_PAGES === 'true' ? '/musashino-kazuno-fs/' : null

  return {
    base: githubPagesBase ?? (process.env.FIGMA_PUBLIC_URL ? `${process.env.FIGMA_PUBLIC_URL}/` : '/'),
    build: {
